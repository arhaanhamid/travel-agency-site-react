        ...
        <div className="md:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-1 sm:gap-5 md:gap-20 ">
          ...
          <div className="hidden md:flex md:flex-col">
            ...
            <ul className="flex flex-col space-y-2 text-sm">
              <Link to={`/services/packages`}>Small Group Departures</Link>
              <Link to={`/services/packages`}>Affordable Dreams</Link>
              <Link to={`/services/packages`}>Private Tours</Link>
              <Link to={`/services/packages`}>Solo Tours</Link>
              <Link to={`/services/packages`}>Religious Tours</Link>
              <Link to={`/services/packages`}>Let Us Guide You</Link>
            </ul>
          </div>
