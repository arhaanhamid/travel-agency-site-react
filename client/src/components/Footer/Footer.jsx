function Footer() {
  return (
    <footer className="bg-stone-100 text-stone-800 dark:bg-stone-900 dark:text-stone-100">
      <div className="mx-auto max-w-7xl px-6 py-12">
        {/* Main Grid */}
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          {/* Left Column - TALOGED EXPERIENCES */}
          <div className="col-span-2">
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
              {/* Destinations Column */}
              <div>
                <ul className="space-y-3 text-sm">
                  <li className="font-bold text-lg">Destinations</li>
                  <li>Gulmarg</li>
                  <li>Sonmarg</li>
                  <li>Gurez</li>
                  <li>Brein</li>
              ...
              {/* Tailored Experience Column */}
              <div>
                <ul className="space-y-3 text-sm">
                  <li className="font-bold text-lg">Tailored Experience</li>
              ...
              {/* Private Rentals Column */}
              <div>
                <ul className="space-y-3 text-sm">
                  <li className="font-bold text-lg">Private Rentals</li>
                  <li>Hotels</li>
                  <li>Houseboats</li>
                  <li>Cars</li>
                </ul>
