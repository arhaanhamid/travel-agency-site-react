...
export const LeftSwiperArrow = ({ requestFrom }) => {
  ...
  const customStyles = testimonials
    ...
    : popularTrips
      ? `hidden md:flex md:items-center md:justify-center group cursor-pointer custom-prev absolute left-4 ${popularTrips && "left-1/3 lg:left-1/3"} top-1/2 -translate-y-1/2 z-10 h-14 w-14 bg-white p-2 rounded-full transition-transform duration-300 hover:scale-150 ${styles.rotate_hover_parent}`
...
export const RightSwiperArrow = ({ requestFrom }) => {
  ...
  const customStyles = testimonials
    ...
    : popularTrips
      ? `hidden md:flex md:items-center md:justify-center group cursor-pointer custom-next absolute right-4 ${popularTrips && "right-4 lg:right-4 "}  top-1/2 -translate-y-1/2 z-10 h-14 w-14 bg-white p-2 rounded-full transition-transform duration-300 hover:scale-150 ${styles.rotate_hover_parent}`
